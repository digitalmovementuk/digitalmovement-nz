...
export function HomePage({sharePath}: {sharePath?: string} = {}){
 ...
 return <div className="dm-home" ref={home}><Seo title="Digital Movement NZ | Marketing that brings real enquiries" description="Make your marketing spend count. SEO, Google Ads, social media and web design for New Zealand businesses. Talk to Martey and get your free plan." path={sharePath ?? "/"} noindex={!!sharePath} schema={[faqSchema(faqs)]}/><HomeHero/><AdVideo/>
