...
export const pricing: SeoPageContent = {
  ...
  local: {
    ...
    stats: [
      ...
      { value: "Month by month", label: "after the first three" },
      { value: "Free", label: "plan before you commit to anything" },
    ],
  },
  ...
  included: {
    eyebrow: "In every level",
    headlineMain: "What you get",
    headlineSub: "at any price.",
    intro:
      "None of this changes between levels. What changes is how many pages, towns and searches it gets applied to.",
    columns: [
      {
        title: "The work",
        items: [
          "We check what's broken on your site, then fix it",
          "We work out which searches are worth chasing, and who holds them",
      ...
      },
      {
        ...
        items: [
          ...
          "Your rankings next to the competitors we named",
          "Enquiries traced back to the page that sent them",
          "The real sites linking to you, not a link count",
  ...
  process: {
    ...
    intro:
      "Nobody can quote this off a phone call. The free plan turns your situation into a scope, and the scope into a price.",
    steps: [
      {
        eta: "Day 1",
        title: "Send us your site",
        body: "Your website address and the towns you want work from. That's enough to start.",
      },
      {
        eta: "Days 2–4",
        title: "We go through it",
        body: "What's broken, where you rank now, who you're actually up against, and where the reachable gaps are. Free, and yours whether you hire us or not.",
      },
      {
        eta: "Day 5",
      ...
      },
      {
        ...
        body: "No pressure and no follow-up emails. If the number doesn't work, the plan is still yours to act on.",
      },
    ],
  },
  ...
  nearby: {
    ...
    headlineSub: "applies.",
    intro: "The structure is the same everywhere. What changes is how much work the market demands.",
    links: [
      {
        label: "SEO New Zealand",
        to: "/seo",
        blurb: "What this involves nationally, and what a NZ business can realistically win.",
      },
      {
  ...
  faq: {
    ...
    intro: "The questions people ask once they stop being polite about money.",
    items: [
      {
      ...
      },
      {
        ...
        a: "Three months to start, then month by month. The three months exist because the setup work is front-loaded — the repairs and the first new pages take that long to land, and judging it before they have tells you nothing. After that you can leave any month, with no exit fee.",
      },
      {
        q: "What makes one business more expensive than another?",
        a: "Four things: how hard your searches are to win, how much repair the site needs first, how many pages the plan calls for, and whether we write the words or you supply them. Auckland and online stores cost more than Dunedin because page one is genuinely harder to reach.",
      },
      {
        q: "Are there setup fees or extras?",
        a: "No. The monthly price is the cost, and it doesn't move unless the scope moves and you've agreed to it first. No markup, no charge per report, no surprise invoice.",
      },
      {
      ...
      },
      {
        ...
        a: "After the first three months you leave, and nothing is holding you. We'd rather earn next month than trap you in it — and the monthly report is built to make the answer obvious either way, which is the opposite of how most agency reporting works.",
      },
      {
        q: "Do I have to pay for the plan?",
        a: "No. It's free and it's yours to keep whether you hire us or not, including what's broken on the site and which searches you're missing. It exists so both sides can price the work honestly instead of guessing.",
      },
    ],
  },
