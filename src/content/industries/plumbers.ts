...
export const plumbers: SeoPageContent = {
  ...
  hero: {
    ...
    sub: "A burst pipe gets searched on a phone, right now, by someone standing in it. They tap the first result that looks like it can help and they ring it. We build so that's you, not the truck three suburbs over.",
    chips: ["5.0 Google rating", "100+ verified reviews", "Searches agreed in writing", "Free plan, no obligation"],
    formHeading: "Get your free plumbing SEO plan",
  ...
  local: {
    ...
    headlineSub: "not just the search.",
    paragraphs: [
      "Most emergency searches never scroll past the map block at the top of Google — three businesses, a rating, a phone number. That's where the job gets decided. Getting into it, with a site that loads fast and puts your number on the first screen, matters more for plumbers than for almost any other trade.",
      "Reviews do more work here too, because someone standing in a flooding laundry hasn't got time to compare three quotes. They read the stars, skim the last few comments, and ring. A thin or stale review page loses you jobs you never knew you were in for.",
      "Not every job is an emergency, though. A callout, a maintenance contract and a bathroom reno are three different searches with three different margins. The burst pipe wants a number to ring now. The reno wants photos, a rough price and time to think. Same business, different pages.",
    ],
    stats: [
      { value: "Map block", label: "the three results most burst-pipe searches never scroll past" },
      { value: "PGDB", label: "the registration every practising NZ plumber holds — put it where people see it" },
      { value: "Now", label: "when an emergency search happens, not when it suits" },
    ],
  },
  ...
  outcomes: {
    ...
    intro: "Getting found in the exact moment someone's standing over a leak deciding who to call.",
    items: [
      {
        kicker: "Visibility",
        title: "Turn up on the emergency search",
        body: "We go after the searches people make with water on the floor — the ones where they ring the first plumber they see instead of shopping around. Those are the fastest jobs to win, so they come first.",
      },
      {
        kicker: "Response",
        value: "Phone",
        ...
        body: "Nearly all of these searches happen on a phone, mid-panic. We build so your number is one tap away, not buried under a scroll.",
      },
      {
        kicker: "Trust",
        value: "Reviews",
        ...
        body: "When someone's choosing in a hurry, reviews carry more weight than anywhere else online. We help you collect them and put them where they'll be read.",
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          ...
          "We split the emergency searches from the planned work and go after both",
          "A plan for the map block and your Google listing",
      ...
      },
      {
        ...
        items: [
          ...
          "Pages built for someone searching on a phone in a hurry",
  ...
  process: {
    ...
    steps: [
      ...
      { eta: "Month 1", title: "Foundations", body: "The broken things get fixed, your Google listing sorted, and the first pages go live. Tracking on." },
  ...
  nearby: {
    ...
    links: [
      { label: "SEO for Builders", to: "/industries/builders", blurb: "Getting found by homeowners ready to build." },
  ...
  faq: {
    ...
    intro: "What plumbers ask before booking a free plan.",
    items: [
      {
        q: "What does it cost?",
        a: "One fixed price a month, not per click and not per lead. What it comes to depends on your area and how hard your searches are to win. Ask for the free plan and you'll get a real figure, not a range.",
      },
      {
        q: "Does this work for emergency jobs, or is that all Google Ads?",
        a: "Plenty of emergency searches land on the map block and the normal results before anyone touches an ad. Getting in there, with a fast phone-first site, wins jobs you'd otherwise pay for every single time.",
      },
      {
      ...
      },
      {
        ...
        a: "Some movement usually shows in the first two to four weeks, because the technical fixes land first. Calls follow later — most plumbers are looking at a few months before the phone genuinely changes. You'll see the movement every month either way.",
      },
      {
      ...
      {
        q: "Can you sort my Google listing, not just the website?",
        a: "Yes, and for plumbers it usually matters more than the website. Categories, service areas, review flow — that's what shows up first when someone searches in an emergency.",
      },
      {
        q: "I'm already the best-known plumber round here. Do I still need this?",
        a: "A good name only helps the people who've heard it. This puts your reviews, your registration and your rankings in front of everyone else searching.",
      },
    ],
  },
  ...
  finalCta: {
    ...
    headlineSub: "your plumbing business.",
