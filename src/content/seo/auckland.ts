...
export const auckland: SeoPageContent = {
  slug: "auckland",
  path: "/seo/auckland",
  city: "Auckland",
  region: "Auckland",
  ...
  meta: {
    title: "SEO Auckland | Digital Movement — Free Plan, No Long Lock-In",
    description:
      "SEO Auckland for trades and local businesses. Free plan, target searches agreed in writing, three months to start then month by month. See where you stand before you commit.",
  },

  keywords: {
    primary: { term: "seo auckland", volume: 1300, kd: 45 },
    secondary: [
      { term: "seo agency auckland", volume: 1000, kd: 43 },
      { term: "seo company auckland", volume: 1000, kd: 41 },
      { term: "seo services auckland", volume: 480, kd: 38 },
      { term: "seo consultant auckland", volume: 320, kd: 51 },
      { term: "seo expert auckland", volume: 320, kd: 36 },
      { term: "auckland seo specialist", volume: 110, kd: 39 },
    ],
  },
  ...
  proof: {
    ...
    intro:
      "These are real Digital Movement reviews, earned by the wider business rather than by the New Zealand company — so not Auckland businesses, and not all trades. We'd rather show you the standard we hold ourselves to than dress up a local case study we don't have yet.",
  },
