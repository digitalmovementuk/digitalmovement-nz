...
export const hamilton: SeoPageContent = {
  slug: "hamilton",
  path: "/seo/hamilton",
  city: "Hamilton",
  region: "Waikato",
  ...
  keywords: {
    primary: { term: "seo hamilton", volume: 320, kd: 8 },
    secondary: [
      { term: "hamilton seo services", volume: 260, kd: 13 },
      { term: "seo services hamilton", volume: 260, kd: 15 },
      { term: "hamilton seo company", volume: 170, kd: 14 },
      { term: "seo company hamilton", volume: 170, kd: 13 },
    ],
  },
