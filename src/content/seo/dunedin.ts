...
export const dunedin: SeoPageContent = {
  slug: "dunedin",
  path: "/seo/dunedin",
  city: "Dunedin",
  region: "Otago",
  ...
  keywords: {
    primary: { term: "seo dunedin", volume: 110, kd: 6 },
    // Semrush returns no monthly-search volume for these Dunedin variants — they
    // sit below its NZ reporting threshold. Volume 0 here means "no data",
    // not "no demand"; we're targeting them on inference from buyer intent.
    secondary: [
      { term: "dunedin seo services", volume: 0, kd: 0 },
      { term: "seo services dunedin", volume: 0, kd: 0 },
      { term: "seo company dunedin", volume: 0, kd: 0 },
      { term: "seo agency dunedin", volume: 0, kd: 0 },
      { term: "otago seo", volume: 0, kd: 0 },
    ],
  },
