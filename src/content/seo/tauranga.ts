...
export const tauranga: SeoPageContent = {
  ...
  local: {
    ...
    headlineMain: "Built for how",
    headlineSub: "Tauranga actually grows.",
    paragraphs: [
      "Tauranga isn't one market, it's several stitched together. The Port of Tauranga is New Zealand's largest port by cargo volume, and that single fact shapes a huge slice of the local economy — freight, logistics, warehousing, engineering, and every trade that services them. A business searching for customers in Tauranga is often competing for attention from people who work shifts, not office hours.",
      "Then there's the growth. Tauranga and the wider Western Bay of Plenty have been among the fastest-growing population areas in the country for years, and that growth shows up as new-build subdivisions — Tauriko, Papamoa East, the Pyes Pa hills. If you're a builder, plumber, electrician or landscaper here, a huge share of your work is new construction, not renovation. That's a genuinely different SEO problem to a city rebuilding after a disaster: you're not competing for insurance jobs, you're competing to be the first name a new subdivision search turns up.",
      "Kiwifruit and horticulture still anchor the wider region — Te Puke, Katikati, the orchards spreading out from the city. Rural service businesses, from irrigation to fencing to machinery, sit in a different search pattern again, one where 'near me' has to mean the whole Bay, not just the CBD.",
  ...
  outcomes: {
    ...
    intro: "Real visibility in a market that's still growing fast enough for new customers to be searching for a business like yours right now.",
    items: [
      {
        kicker: "Visibility",
        value: "Page 1",
      ...
      },
      {
        ...
        value: "New",
        unit: "subdivisions",
        title: "Catch customers as they arrive",
        body: "Tauranga's population is still growing fast. We position you to be found by the people moving in, building, and searching for trades right now.",
      },
      {
        kicker: "Coverage",
        value: "Whole",
        unit: "Bay",
        title: "Beyond just the CBD",
        body: "Mount Maunganui, Papamoa, Tauriko, Bethlehem, Greerton — we build visibility across the suburbs your customers actually live in.",
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          "Technical SEO audit",
          "Tauranga keyword & suburb mapping",
          "Bay of Plenty competitor analysis",
      ...
      },
      {
        ...
        items: [
          ...
          "Local landing pages for Mount, Papamoa, Tauriko and more",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Both. We build local landing pages, Google Business Profile optimisation, and content mapped to Tauranga suburbs, alongside the same technical and content SEO work we run for any NZ business.",
      },
      {
        q: "Do you work with businesses in Mount Maunganui and Papamoa?",
        a: "Yes. Mount Maunganui, Papamoa, Papamoa East, Bethlehem, Tauriko, Greerton — we map your keyword strategy to the suburbs your customers actually search from, not just 'Tauranga' as one generic term.",
      },
      {
      ...
      },
      {
        ...
        a: "New-build areas mean search demand that grows every month as more sections are built and sold, so the strategy leans on local landing pages and fresh content rather than long-established backlinks. Established suburbs need steadier, reputation-led SEO instead.",
      },
    ],
  },
