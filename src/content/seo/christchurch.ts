...
export const christchurch: SeoPageContent = {
  slug: "christchurch",
  ...
  keywords: {
    primary: { term: "seo christchurch", volume: 880, kd: 13 },
    secondary: [
      { term: "seo consultant christchurch", volume: 880, kd: 12 },
      { term: "christchurch seo agency", volume: 480, kd: 15 },
      { term: "seo agency christchurch", volume: 480, kd: 18 },
      { term: "seo agencies christchurch", volume: 320, kd: 15 },
      { term: "christchurch seo services", volume: 260, kd: 11 },
      { term: "christchurch seo company", volume: 210, kd: 17 },
      { term: "seo services christchurch", volume: 210, kd: 11 },
      { term: "seo company christchurch", volume: 170, kd: 19 },
    ],
  },
  ...
  proof: {
    ...
    intro:
      "These are real Digital Movement reviews, earned by the wider business rather than by the New Zealand company — so not Christchurch businesses, and not all trades. We'd rather show you the standard we hold ourselves to than dress up a local case study we don't have yet.",
  },
