...
export const googleAdsChristchurch: SeoPageContent = {
  slug: "christchurch",
  path: "/google-ads/christchurch",
  city: "Christchurch",
  region: "Canterbury",

  serviceName: "Google Ads Christchurch",
  serviceType: "Google Ads Management",
  hubLabel: "Google Ads",
  hubPath: "/services/google-ads",
  sourcePrefix: "google-ads",
  fidelity: "LOW-FI",
  ...
  keywords: {
    primary: { term: "google ads christchurch", volume: 1600, kd: 9 },
    secondary: [
      { term: "google ads agency christchurch", volume: 210, kd: 14 },
      { term: "google ads management christchurch", volume: 170, kd: 11 },
      { term: "google ads consultant christchurch", volume: 140, kd: 10 },
      { term: "ppc agency christchurch", volume: 110, kd: 16 },
      { term: "google ads expert christchurch", volume: 90, kd: 9 },
      { term: "christchurch google ads agency", volume: 70, kd: 13 },
      { term: "google adwords christchurch", volume: 50, kd: 8 },
    ],
  },
