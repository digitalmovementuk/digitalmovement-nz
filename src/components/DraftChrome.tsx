...
export function DraftStickyCTA(){
 ...
 useEffect(()=>{
  ...
  const update=()=>{
   frame=0;
   if(!mobile.matches||pathname!=='/'||document.querySelector('dialog[open]')){setVisible(false);return;}
