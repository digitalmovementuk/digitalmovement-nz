...
export function Layout() {
 ...
 return <div className={`dm-draft ${isHomePath(pathname) ? 'dm-home-route' : 'dm-inner-route'}`}><a className="dm-skip" href="#main">Skip to content</a><DraftNav /><main id="main" tabIndex={-1}><Outlet /></main><DraftStickyCTA /><DraftFooter /></div>;
}
