...
// Subpage routes are lazy-loaded — they aren't on the homepage critical path
// so they shouldn't bloat the initial bundle.
const AboutUs = lazy(() => import("./pages/AboutUs").then((m) => ({ default: m.AboutUs })));
const NotFound = lazy(() => import("./pages/NotFound").then((m) => ({ default: m.NotFound })));
const ServiceSEO = lazy(() =>
  import("./pages/services/seo").then((m) => ({ default: m.ServiceSEO })),
);
...
function RouteFallback() {
  return <div className="min-h-screen surface-light" aria-hidden />;
}
